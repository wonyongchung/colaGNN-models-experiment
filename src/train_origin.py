...
ap.add_argument('--dataset', type=str, default='exchange_rate', help="Dataset string")
ap.add_argument('--sim_mat', type=str, default='exchange_rate_adj', help="adjacency matrix filename (*-adj.txt)")
...
ap.add_argument('--epochs', type=int, default=300, help='number of epochs to train')
...
for horizon in horizonlist:
    ...
    f = open('./performance_record/{0}_{1}_origin.csv'.format(args.dataset, args.horizon), 'a', newline="", encoding='utf-8')
    wr = csv.writer(f)
